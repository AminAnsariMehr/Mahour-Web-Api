...
const questionOption = (questionID, optionID, optionTitle, optionType) => {
    ...
    <textarea name="${questionID}" id="${questionID}" cols="30" rows="10" placeholder="توضیحات: "></textarea>`;
		...
		return `<section class="productOrderData">
				<section class="uploadDataSection">
					<div class="uploadImageSection">
						<img class="uploadImageSection__image" src="./assets/images/dynamicLogic/uploadIcon.png"
							alt="bgUploadIcon">
						<div class="uploadImageSection__textWrapper">
							<p class="uploadImageSection__title">انتخاب تصویر</p>
							<p class="uploadImageSection__description">
								تصاویر مربوطه را از گالری یا دوربین انتخاب کنید
							</p>
						</div>
					</div>
					<section class="uploadInputsWrapper">
						<label for="uploadFileBtn" class="uploadInputsWrapper__uploadBtn">
							<img class="uploadInputsWrapper__uploadIcon"
								src="./assets/images/dynamicLogic/folder-add.png">
							<span class="uploadInputsWrapper__text">انتخاب از گالری</span>
						</label>
						<input id="uploadFileBtn" class="uploadInputsWrapper__uploadInvisibleInput" type="file" multiple>

						<button class="uploadInputsWrapper__uploadBtn">
							<img class="uploadInputsWrapper__uploadIcon" src="./assets/images/dynamicLogic/camera.png">
							<span class="uploadInputsWrapper__text">باز کردن دوربین</span>
						</button>
					</section>
				</section>
			</section>`;
